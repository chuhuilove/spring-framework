...
/**
 *
 * 对于声明{@link ExceptionHandler @ExceptionHandler},
 * {@link InitBinder @InitBinder}或{@link ModelAttribute @ModelAttribute}方法以在多个{@code @Controller}类之间共享的类,
 * 专门使用{@link Component @Component}.
 *
