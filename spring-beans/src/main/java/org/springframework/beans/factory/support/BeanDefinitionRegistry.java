...
/**
 * 用于保存bean定义的注册接口,例如RootBeanDefinition和ChildBeanDefinition实例.
 * 通常由内部使用AbstractBeanDefinition层次结构的BeanFactories实现.
 *
 * <p>这是Spring的bean factory包中惟一封装bean定义<i>注册</i>的接口.
